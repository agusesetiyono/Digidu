...
class Auth extends MY_Controller {
	...
	function index()
	{
		...
		if (!$this->ion_auth->logged_in())
		{
			...
			redirect('blog/auth/login', 'refresh');
	...
	function login()
	{
		...
		if ($this->form_validation->run() == true)
		{
			...
			else
			{
				...
				redirect('blog/auth/login', 'refresh'); //use redirects instead of loading views for compatibility with MY_Controller libraries
			}
		}
		else
		{
			...
			$this->_render_page('blog/auth/login', $this->data);
		}
	}
	...
	function change_password()
	{
		...
		else
		{
			...
			{
				$this->session->set_flashdata('message', $this->ion_auth->errors());
				redirect('blog/auth/change_password', 'refresh');
			}
		}
	}
		...
		if ($user)
		{
			...
			else
			{
				...
				else
				{
					...
					{
						$this->session->set_flashdata('message', $this->ion_auth->errors());
						redirect('blog/auth/reset_password/' . $code, 'refresh');
					}
				}
			}
		}
