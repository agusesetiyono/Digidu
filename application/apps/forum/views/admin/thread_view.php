<div class="span10">  
    ...
    <tbody>
        ...
        <td style="text-align: center;"><a title="edit" href="<?php echo site_url('forum/admin/thread_edit').'/'.$thread->id; ?>"><img src="<?php echo base_url(); ?>resources/icons/pencil.png"/></a> </td>
        <td style="text-align: center;"><a title="delete" class="del" id="thread_id<?php echo $thread->id; ?>" href="<?php echo site_url('forum/admin/thread_delete').'/'.$thread->id; ?>"><img src="<?php echo base_url(); ?>resources/icons/delete.png"/></a> </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
    </table>
